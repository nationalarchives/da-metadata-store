locals {
  web_client_secret_path = "/${var.environment}/client/web/secret"
  web_client_id_path     = "/${var.environment}/client/web/id"
  api_client_secret_path = "/${var.environment}/client/api/secret"
  api_client_id_path     = "/${var.environment}/client/api/id"
}
