...
module "rds_kms" {
  source   = "git::https://github.com/nationalarchives/da-terraform-modules//kms?ref=main"
  ...
  default_policy_variables = {
    ...
    service_details = [{ service_name = "rds" }]
  }
}
...
resource "aws_rds_cluster_instance" "metadata_store" {
  ...
  performance_insights_kms_key_id = module.rds_kms.kms_key_arn
  tags = {
